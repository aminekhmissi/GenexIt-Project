  ...
  async createReservation(req, res) {
    try {
      ...
      if (
        ...
        const reserved = await Reservation.findById(lodge.reservation);
        if (
          ...
          msg =
            "can't reserve include other reservation : other reservation exists between " +
            moment(reserved.checkIn).format("dddd, MMMM Do YYYY") +
            " and " +
            moment(reserved.checkOut).format("dddd, MMMM Do YYYY");
        }
      } else {
